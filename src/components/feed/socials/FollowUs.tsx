  ...
  return (
    <div className='flex flex-col w-full space-y-4 text-gray-700 mt-4'>
      ...
      <div className='flex flex-col w-full space-y-2'>
        ...
        <button>
          <a
            href='https://www.youtube.com/channel/UCTRJW9ZVk1Q0aR3q2krhtDw'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <button>
          <a
            href='https://twitch.tv/sccabreiros'
            target='_blank'
            rel='noreferrer'
          >
            <div className='flex text-white w-full bg-purple-500 items-center rounded-sm shadow-md'>
              <p className='bg-purple-600 p-3 rounded-sm'>
                <BsTwitch />
              </p>
              <p className='flex p-2 w-full'>Twitch</p>
            </div>
          </a>
        </button>
      </div>
